...
const {
  role: { create: createRole, basicAssumeRolePolicy },
  policy: { create: createPolicy, attachRolePolicy, basicLambdaPolicy, detachRolePolicy }
} = require("./iam.js")
const { create: createLambda } = require("./lambda.js")
const { createApi, attachLambdaToApi, createDeployment } = require("./apiGateway.js")
